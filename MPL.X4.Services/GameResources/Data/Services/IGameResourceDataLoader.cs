...
public interface IGameResourceDataLoader
{
    ...
    /// <param name="index">An <see cref="IEnumerable{ICatalogIndexEntry}"/> that is the catalog file index.</param>
    /// <returns>A <see cref="Task{TResult}"/> representing the asynchronous operation.  An <see cref="IOffsetDataDictionary"/> that is the result.</returns>
    Task<IOffsetDataDictionary> LoadOffsetsFromIndex(IEnumerable<ICatalogIndexEntry> index);
    ...
    /// <param name="index">An <see cref="IEnumerable{ICatalogIndexEntry}"/> that is the catalog file index.</param>
    /// <returns>A <see cref="Task{TResult}"/> representing the asynchronous operation.  An <see cref="IMacroNameResourceDataDictionary"/> that is the result.</returns>
    Task<IMacroNameResourceDataDictionary> LoadSectorNamesFromIndex(IEnumerable<ICatalogIndexEntry> index);
    ...
    /// <param name="index">An <see cref="IEnumerable{ICatalogIndexEntry}"/> that is the catalog file index.</param>
    /// <returns>A <see cref="Task{TResult}"/> representing the asynchronous operation.  An <see cref="IMacroNameResourceDataDictionary"/> that is the result.</returns>
    Task<IMacroNameResourceDataDictionary> LoadShipModelsFromIndex(IEnumerable<ICatalogIndexEntry> index);
    ...
    /// <param name="index">An <see cref="IEnumerable{ICatalogIndexEntry}"/> that is the catalog file index.</param>
    /// <returns>A <see cref="Task{TResult}"/> representing the asynchronous operation.  An <see cref="IMacroNameResourceDataDictionary"/> that is the result.</returns>
    Task<IMacroNameResourceDataDictionary> LoadWareNamesFromIndex(IEnumerable<ICatalogIndexEntry> index);
}
